...
\note{
    ...
    The following formula is useful in the following reasonning
...
\begin{frame}{Take-home message \#2 and what's next}
    \metroset{block=fill}
...
\note{
    Briefly explain why another model is needed (I think the Coursera MOOC contains a short and
    convincing explanation about that, cool to introduce next section).
}
