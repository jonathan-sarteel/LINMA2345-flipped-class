...
\begin{frame}{Repeated game with standard information}
    ...
    \begin{block}{Definition}
        A {\color{green}standard repeated game} is an infinitely repeated game where a same game
        $\Gamma$ is repeated infinitely and where at each round $k$, every player knows
        all the players past moves. And there exist only one possible state of nature.
