...
\note{
    \textbf{For any general repeated game, if the payoffs are bounded, then the $\delta$-discounted
...
\begin{frame}{Take-home message \#3}
    ...
    \begin{block}{Take-home message \#3}
        There exists several criteria for ranking sequence of payoffs $(u_i(1), u_i(2), u_i(3), \dots)$
        \begin{itemize}
