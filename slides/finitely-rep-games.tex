...
\note{
    ...
    threat of punishment is not subgame-perfect (i.e. not credible). Important not to spoil the
    next example if this question is raised.
}
...
\begin{frame}{Take-home message \#1 and social experiments}
    ...
    Dilemma, contradicting backward induction. See for example~\cite{pd-repeated-real-life}
...
\note{
    ...
    footnote on the first page. I personnaly never saw that before.
}
